    ...
    if ply:Alive() then
      if !contextMenuOpen then
        ...
        if tonumber( cl_db["ttt"] ) == 1 then
          ...
          drawText( "F3 - " .. lang.rolemenu, "ttf", cl_db["ttx"] + ctrW( 32 ), cl_db["tty"] + 10 + 2*_abstand, Color( 255, 255, 255, 200 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
          ...
          drawText( "F11  - " .. lang.guimouse, "ttf", cl_db["ttx"] + ctrW( 32 ), cl_db["tty"] + 10 + 5*_abstand, Color( 255, 255, 255, 200 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
          drawText( "B  - " .. lang.changeview, "ttf", cl_db["ttx"] + ctrW( 32 ), cl_db["tty"] + 10 + 6*_abstand, Color( 255, 255, 255, 200 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
          drawText( "M  - " .. lang.map, "ttf", cl_db["ttx"] + ctrW( 32 ), cl_db["tty"] + 10 + 7*_abstand, Color( 255, 255, 255, 200 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
          drawText( "H  - " .. "Eat Food", "ttf", cl_db["ttx"] + ctrW( 32 ), cl_db["tty"] + 10 + 8*_abstand, Color( 255, 255, 255, 200 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
          drawText( "T  - " .. "Drink Water", "ttf", cl_db["ttx"] + ctrW( 32 ), cl_db["tty"] + 10 + 9*_abstand, Color( 255, 255, 255, 200 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
        end
