...
function tabClientChar( sheet )
  ...
  sheet:AddSheet( "Charakter", cl_charPanel, "icon16/user_edit.png" )
  function cl_charPanel:Paint( w, h )
    ...
    draw.SimpleText( "FirstName:", "DermaDefault", calculateToResu( 10 ), calculateToResu( 10 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
    draw.SimpleText( "SurName:", "DermaDefault", calculateToResu( 10 ), calculateToResu( 110 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
  end
