...
function tabServerMap( sheet )
  ...
  function _mapName:Paint( pw, ph )
    ...
    draw.SimpleText( "Map: " .. string.lower( game.GetMap() ), "DermaDefault", calculateToResu( 10 ), calculateToResu( 10 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
  end

  _mapListView = createVGUI( "DListView", sv_mapPanel, 1600, 1600, 10, 10 + 256 + 10 )
  _mapListView:AddColumn( "uniqueID" ):SetFixedWidth( 100 )
  _mapListView:AddColumn( "Position" ):SetFixedWidth( 200 )
  _mapListView:AddColumn( "Angle" ):SetFixedWidth( 200 )
  _mapListView:AddColumn( "Type" )
  _mapListView:AddColumn( "Group" )

  local _buttonDelete = createVGUI( "DButton", sv_mapPanel, 400, 50, 10 + 1600 + 10, 10 + 256 + 10 )
  _buttonDelete:SetText( "DELETE Entry")
  ...
  _buttonAddSpawnPoint:SetText( "Add Spawnpoint" )
  function _buttonAddSpawnPoint:DoClick()
    local tmpFrame = createVGUI( "DFrame", nil, 400, 10 + 50 + 10 + 50 + 10 + 50 + 10 + 50 + 10, 0, 0 )
    tmpFrame:Center()
    tmpFrame:SetTitle( "" )
    function tmpFrame:Paint( pw, ph )
      draw.RoundedBox( 0, 0,0, pw, ph, yrpsettings.color.background )
      draw.SimpleText( "Spawnpoint Creator", "DermaDefault", calculateToResu( 10 ), calculateToResu( 10 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
      draw.SimpleText( "Creates a spawnpoint on your Position", "DermaDefault", calculateToResu( 10 ), calculateToResu( 50 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
      draw.SimpleText( "Select Group:", "DermaDefault", calculateToResu( 10 ), calculateToResu( 90 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
    end
    ...
    local tmpButton = createVGUI( "DButton", tmpFrame, 200, 50, 100, 50 + 10 + 50 + 10 + 50 + 10 )
