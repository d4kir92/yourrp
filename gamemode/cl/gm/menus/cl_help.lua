...
function openHelpMenu()
  ...
  function _hm.window:Paint( pw, ph )
    ...
    draw.SimpleTextOutlined( "[" .. "F7" .. "] " .. "Feedback Menu", "ttsf", ctr( 10 ) + ctr( 32 ), ctr( 10 ) + ctr( 10 ) + ctr( 16*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
