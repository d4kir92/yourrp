...
AddCSLuaFile( "cl/gm/menus/cl_appearance.lua" )
...
AddCSLuaFile( "cl/gm/menus/settings/cl_settings_server_collection.lua" )
AddCSLuaFile( "cl/gm/menus/settings/cl_settings_server_general.lua" )
AddCSLuaFile( "cl/gm/menus/settings/cl_settings_server_interface.lua" )
...
AddCSLuaFile( "cl/gm/menus/settings/cl_settings_server_feedback.lua" )
