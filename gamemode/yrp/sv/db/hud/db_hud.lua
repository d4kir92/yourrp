...
function DefaultHUDSettings(reset)
	...
	ST.colors.BA = "200, 200, 50, 200"
	ST.colors.BR = "200, 200, 50, 200"
	ST.ints = {}
	ST.ints.AX = 1
	ST.ints.AY = 1
	ST.ints.TS = 24
	...
	TH.colors.BA = "52, 70, 150, 200"
	TH.colors.BR = "52, 70, 150, 200"
	TH.ints = {}
	TH.ints.AX = 1
	TH.ints.AY = 1
	TH.ints.TS = 24
	...
	CA.colors.BA = "132, 116, 188, 200"
	CA.colors.BR = "132, 116, 188, 200"
	CA.ints = {}
	CA.ints.AX = 1
	CA.ints.AY = 1
	CA.ints.TS = 24
	...
	AB.colors.BA = "58, 143, 255, 200"
	AB.colors.BR = "58, 143, 255, 200"
	AB.ints = {}
	AB.ints.AX = 1
	AB.ints.AY = 1
	AB.ints.TS = 24
	...
	WP.colors.BA = "40, 40, 40, 200"
	WP.colors.BR = "40, 40, 40, 200"
	WP.ints = {}
	WP.ints.AX = 1
	WP.ints.AY = 1
	WP.ints.TS = 24
	...
	WS.colors.BA = "40, 40, 40, 200"
	WS.colors.BR = "40, 40, 40, 200"
	WS.ints = {}
	WS.ints.AX = 1
	WS.ints.AY = 1
	WS.ints.TS = 24
	...
	WN.colors.BA = "40, 40, 40, 200"
	WN.colors.BR = "40, 40, 40, 200"
	WN.ints = {}
	WN.ints.AX = 1
	WN.ints.AY = 1
	WN.ints.TS = 24
	...
	MI.colors.BA = "0, 0, 0, 200"
	MI.colors.BR = "0, 0, 0, 200"
	MI.ints = {}
	MI.ints.AX = 1
	MI.ints.AY = 4
	MI.ints.TS = 24
	...
	BA.colors.BA = "255, 255, 0, 200"
	BA.colors.BR = "255, 255, 0, 200"
	BA.ints = {}
	BA.ints.AX = 1
	BA.ints.AY = 1
	BA.ints.TS = 24
	...
	CON.colors.BA = "0, 0, 0, 200"
	CON.colors.BR = "0, 0, 0, 200"
	CON.ints = {}
	CON.ints.AX = 1
	CON.ints.AY = 1
	CON.ints.TS = 24
	...
	PE.colors.BA = "0, 0, 0, 200"
	PE.colors.BR = "0, 0, 0, 200"
	PE.ints = {}
	PE.ints.AX = 0
	PE.ints.AY = 1
	PE.ints.TS = 18
	...
	NE.colors.BA = "0, 0, 0, 200"
	NE.colors.BR = "0, 0, 0, 200"
	NE.ints = {}
	NE.ints.AX = 0
	NE.ints.AY = 1
	NE.ints.TS = 18
	...
	COM.colors.BA = "0, 0, 0, 200"
	COM.colors.BR = "0, 0, 0, 200"
	COM.ints = {}
	COM.ints.AX = 1
	COM.ints.AY = 1
	COM.ints.TS = 18
	...
	LO.colors.BA = "0, 0, 0, 200"
	LO.colors.BR = "0, 0, 0, 200"
	LO.ints = {}
	LO.ints.AX = 1
	LO.ints.AY = 1
	LO.ints.TS = 30
	...
	AV.colors.BA = "150, 52, 52, 200"
	AV.colors.BR = "150, 52, 52, 200"
	AV.ints = {}
	AV.ints.AX = 1
	AV.ints.AY = 1
	AV.ints.TS = 24
	...
	PM.colors.BA = "150, 52, 52, 200"
	PM.colors.BR = "150, 52, 52, 200"
	PM.ints = {}
	PM.ints.AX = 1
	PM.ints.AY = 1
	PM.ints.TS = 24
	...
	SL.colors.BA = "150, 52, 52, 200"
	SL.colors.BR = "150, 52, 52, 200"
	SL.ints = {}
	SL.ints.AX = 1
	SL.ints.AY = 1
	SL.ints.TS = 24
	...
	SN.colors.BA = "150, 52, 52, 200"
	SN.colors.BR = "150, 52, 52, 200"
	SN.ints = {}
	SN.ints.AX = 1
	SN.ints.AY = 1
	SN.ints.TS = 24
