...
function _mat1.DrawWindow( window, pw, ph, title )
  ...
  --[[ Title ]]--
  surfaceText( lang_string( _title ), "mat1header", ctr( 10 ), ctr( 25 ), Color( 255, 255, 255 ), 0, 1 )
end
...
function _mat1.DrawButton( btn, pw, ph, text, color, px, py, ax, ah )
  ...
  --[[ text ]]--
  surfaceText( lang_string( _text ), "mat1text", px or pw/2, py or ph/2, Color( 255, 255, 255 ), ax or 1, ay or 1 )
end
...
function _mat1.DrawPanel( pnl, pw, ph, text, color, px, py, ax, ah )
  ...
  --[[ text ]]--
  surfaceText( lang_string( _text ), "mat1text", px or pw/2, py or ph/2, color or Color( 255, 255, 255, 255 ), ax or 1, ay or 1 )
end
