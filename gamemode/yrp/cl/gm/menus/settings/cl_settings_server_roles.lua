	...
	for k, v in pairs( yrp_roles_dbTable ) do
		if pa(settingsWindow) then
			...
			function tmp:DoClick()
				...
				--2.Spalte
				addDBNumberWang( rolesInfo, 800, 80, 810, 0, YRP.lang_string( "rolemaxamount" ) .. " (-1 = " .. YRP.lang_string( "disabled" ) .. ")", v.maxamount, yrp_roles_dbTable[k], "yrp_roles", "maxamount", "uniqueID = " .. tmp.uniqueID .. "", -1, game.MaxPlayers(), "how many players can get the role" )
