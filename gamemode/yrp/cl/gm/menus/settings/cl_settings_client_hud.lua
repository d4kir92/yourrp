...
function changeHudElement(parent, tmp, textPre)
	...
	function _tmpSettings:DoClick()
		...
		function _settingsFrame:Paint(pw, ph)
			...
			draw.SimpleText(YRP.lang_string("LID_isvisible"), "DermaDefault", ctr(70),	ctr(85), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
			draw.SimpleText(YRP.lang_string("LID_anchor"), "DermaDefault", ctr(70),	ctr(145), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
			draw.SimpleText(YRP.lang_string("LID_textsize"), "DermaDefault", ctr(110),	ctr(205), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
			draw.SimpleText(YRP.lang_string("LID_textposition"), "DermaDefault", ctr(70),	ctr(265), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
			draw.SimpleText(YRP.lang_string("LID_istextvisible"), "DermaDefault", ctr(70),	ctr(325), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
			draw.SimpleText(YRP.lang_string("LID_isiconvisible"), "DermaDefault", ctr(70),	ctr(385), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
			draw.SimpleText(YRP.lang_string("LID_isrounded"), "DermaDefault", ctr(70),	ctr(445), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		end
...
hook.Add("open_client_hud", "open_client_hud", function()
	...
	--sheet:AddSheet(YRP.lang_string("LID_hud"), cl_hudPanel, "icon16/photo.png")
	...
	function _settingCrosshairPanel:Paint(pw, ph)
		...
		draw.SimpleTextOutlined(YRP.lang_string("LID_thickness") .. ":", "sef", ctr(10), ctr(300), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_BOTTOM, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_border") .. ":", "sef", ctr(10), ctr(400), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_BOTTOM, 1, Color(0, 0, 0))
	end
