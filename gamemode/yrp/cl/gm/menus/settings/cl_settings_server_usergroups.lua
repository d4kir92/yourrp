...
net.Receive( "Connect_Settings_UserGroup", function( len )
  ...
  ACCESS:SetHeader( lang_string( "accesssettings" ) .. " [Translation in work]" )
  function ACCESS.plus:Paint( pw, ph )
    surfaceBox( 0, 0, pw, ph, Color( 80, 80, 80, 255 ) )
  end
  ACCESS.plus:EnableVerticalScrollbar( true )

  function ACCESSAddCheckBox( name, lstr )
  ...
  ACCESSAddCheckBox( "adminaccess", "yrp_adminaccess" )
  ACCESSAddHr()
  ACCESSAddCheckBox( "general", "setting_general" )
  ACCESSAddCheckBox( "interface", "setting_interface" )
  ACCESSAddCheckBox( "realistic", "setting_realistic" )
  ACCESSAddCheckBox( "money", "setting_money" )
  ACCESSAddCheckBox( "licenses", "setting_licenses" )
  ACCESSAddCheckBox( "shops", "setting_shops" )
  ACCESSAddCheckBox( "map", "setting_map" )
  ACCESSAddHr()
  ACCESSAddCheckBox( "feedback", "setting_feedback" )
  ACCESSAddHr()
  ACCESSAddCheckBox( "usergroups", "setting_usergroups" )
  ACCESSAddCheckBox( "groupsandroles", "setting_groupsandroles" )
  ACCESSAddCheckBox( "players", "setting_players" )
  ...
  GAMEPLAY:SetHeader( lang_string( "gameplayrestrictions" ) .. " [Translation in work]" )
  ...
  GAMEPLAYAddCheckBox( "physgunpickupplayer", "gp_physgunpickupplayer" )
end)
