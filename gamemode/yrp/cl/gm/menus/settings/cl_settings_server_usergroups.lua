...
net.Receive("Connect_Settings_UserGroup", function(len)
	...
	ACCESSAddCheckBox("bool_adminaccess", "yrp_adminaccess", Color(255, 255, 0, 255))
	ACCESSAddHr()
	-- OLD
	ACCESSAddCheckBox("bool_interface", "settings_surface")
	ACCESSAddCheckBox("bool_money", "settings_money")
	ACCESSAddCheckBox("bool_licenses", "settings_licenses")
	ACCESSAddCheckBox("bool_shops", "settings_shops")
	ACCESSAddCheckBox("bool_map", "settings_map")
	ACCESSAddCheckBox("bool_players", "settings_players")
	ACCESSAddCheckBox("bool_groupsandroles", "settings_groupsandroles")
	ACCESSAddHr()
	ACCESSAddHr()
	ACCESSAddHr()
	-- Maintance
	ACCESSAddCheckBox("bool_status", "settings_status")
	ACCESSAddCheckBox("bool_feedback", "settings_feedback")
	ACCESSAddHr()
	-- Gameplay
	ACCESSAddCheckBox("bool_realistic", "settings_realistic")
	ACCESSAddHr()
	-- Management
	ACCESSAddCheckBox("bool_general", "settings_general")
	ACCESSAddCheckBox("bool_ac_database", "settings_database", Color(255, 0, 0, 255))
	ACCESSAddCheckBox("bool_usergroups", "settings_usergroups", Color(255, 0, 0, 255))
	ACCESSAddHr()
	-- Addons
	ACCESSAddCheckBox("bool_yourrp_addons", "settings_yourrp_addons")
	...
	GAMEPLAYAddCheckBox("bool_vehicles", "gp_vehicles")
	GAMEPLAYAddCheckBox("bool_weapons", "gp_weapons")
	GAMEPLAYAddCheckBox("bool_entities", "gp_entities")
	GAMEPLAYAddCheckBox("bool_effects", "gp_effects")
	GAMEPLAYAddCheckBox("bool_npcs", "gp_npcs")
	GAMEPLAYAddCheckBox("bool_props", "gp_props")
	GAMEPLAYAddCheckBox("bool_ragdolls", "gp_ragdolls")
	GAMEPLAYAddHr()
	GAMEPLAYAddCheckBox("bool_noclip", "gp_noclip")
	GAMEPLAYAddCheckBox("bool_removetool", "gp_removetool")
	GAMEPLAYAddCheckBox("bool_dynamitetool", "gp_dynamitetool")
	GAMEPLAYAddCheckBox("bool_ignite", "gp_ignite")
	GAMEPLAYAddCheckBox("bool_drive", "gp_drive")
	GAMEPLAYAddCheckBox("bool_flashlight", "gp_flashlight")
	GAMEPLAYAddHr()
	GAMEPLAYAddCheckBox("bool_collision", "gp_collision")
	GAMEPLAYAddCheckBox("bool_gravity", "gp_gravity")
	GAMEPLAYAddCheckBox("bool_keepupright", "gp_keepupright")
	GAMEPLAYAddCheckBox("bool_bodygroups", "gp_bodygroups")
	GAMEPLAYAddHr()
	GAMEPLAYAddCheckBox("bool_physgunpickup", "gp_physgunpickup")
	GAMEPLAYAddCheckBox("bool_physgunpickupplayer", "gp_physgunpickupplayers")
	GAMEPLAYAddCheckBox("bool_physgunpickupworld", "gp_physgunpickupworld")
	GAMEPLAYAddHr()
	GAMEPLAYAddCheckBox("bool_canseeteammatesonmap", "gp_canseeteammatesonmap")
	GAMEPLAYAddCheckBox("bool_canseeenemiesonmap", "gp_canseeenemiesonmap")
end)
