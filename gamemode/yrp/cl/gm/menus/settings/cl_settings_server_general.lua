...
net.Receive("Connect_Settings_General", function(len )
	if pa(settingsWindow ) then
		...
		local bool_hunger_health_regeneration = CreateCheckBoxLine(GAMEMODE_SYSTEMS.plus, GEN.bool_hunger_health_regeneration, "hungerhealthregeneration", "update_bool_hunger_health_regeneration" )
		...
		CreateHRLine(GAMEMODE_SYSTEMS.plus )
		local bool_identity_card = CreateCheckBoxLine(GAMEMODE_SYSTEMS.plus, GEN.bool_identity_card, "identitycard", "update_bool_identity_card" )
		...
		CreateHRLine(GAMEMODE_SYSTEMS.plus )
		local bool_wanted_system = CreateCheckBoxLine(GAMEMODE_SYSTEMS.plus, GEN.bool_wanted_system, "wantedsystem", "update_bool_wanted_system" )
		CreateHRLine(GAMEMODE_SYSTEMS.plus )
		...
		CreateHRLine(GAMEMODE_SYSTEMS.plus )
		local bool_voice_3d = CreateCheckBoxLine(GAMEMODE_SYSTEMS.plus, GEN.bool_voice_3d, "3dvoicechat", "update_bool_voice_3d" )
		...
		local int_voice_local_range = CreateNumberWangLine(GAMEMODE_SYSTEMS.plus, GEN.int_voice_local_range, "localvoicechatdistance", "update_int_voice_local_range" )
		local bool_voice_group_local = CreateCheckBoxLine(GAMEMODE_SYSTEMS.plus, GEN.bool_voice_group_local, "groupvoicechatisaudiblelocally", "update_bool_voice_group_local" )
		local int_voice_group_local_range = CreateNumberWangLine(GAMEMODE_SYSTEMS.plus, GEN.int_voice_group_local_range, "localgroupvoicechatdistance", "update_int_voice_group_local_range" )
		...
		local bool_yrp_chat_show_factionname = CreateCheckBoxLineTab(GAMEMODE_VISUALS.plus, GEN.bool_yrp_chat_show_factionname, "showfactionname", "update_bool_yrp_chat_show_factionname" )
		...
		local bool_tag_on_head_factionname = CreateCheckBoxLineTab(GAMEMODE_VISUALS.plus, GEN.bool_tag_on_head_factionname, "showfactionname", "update_bool_tag_on_head_factionname" )
		...
		CreateCheckBoxLineTab(GAMEMODE_VISUALS.plus, GEN.bool_tag_on_side_factionname, "showfactionname", "update_bool_tag_on_side_factionname" )
