...
net.Receive("Connect_Settings_General", function(len)
	if pa(settingsWindow) and settingsWindow.window != nil then
		...
		CreateHRLine(SERVER_SETTINGS.plus)
		local text_server_name = CreateTextBoxLine(SERVER_SETTINGS.plus, GEN.text_server_name, "LID_hostname", "update_text_server_name")
		...
		local bool_level_system = CreateCheckBoxLine(GAMEMODE_SYSTEMS.plus, GEN.bool_level_system, "LID_levelsystem", "update_bool_level_system")
		CreateHRLine(GAMEMODE_SYSTEMS.plus)
		...
		local bool_yrp_combined_menu = CreateCheckBoxLine(GAMEMODE_VISUALS.plus, GEN.bool_yrp_combined_menu, "LID_combinedmenu", "update_bool_yrp_combined_menu")
		...
		local bool_yrp_scoreboard_show_level = CreateCheckBoxLineTab(GAMEMODE_VISUALS.plus, GEN.bool_yrp_scoreboard_show_level, "LID_showlevel", "update_bool_yrp_scoreboard_show_level")
		...
		local bool_tag_on_head_level = CreateCheckBoxLineTab(GAMEMODE_VISUALS.plus, GEN.bool_tag_on_head_level, "LID_showlevel", "update_bool_tag_on_head_level")
		...
		CreateCheckBoxLineTab(GAMEMODE_VISUALS.plus, GEN.bool_tag_on_side_level, "LID_showlevel", "update_bool_tag_on_side_level")
		...
		CreateHRLine(MONEY_SETTINGS.plus)
		CreateTextBoxLine(MONEY_SETTINGS.plus, GEN.text_money_model, "LID_model", "update_text_money_model")
		CreateHRLine(MONEY_SETTINGS.plus)
