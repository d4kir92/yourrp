...
net.Receive("Connect_Settings_General", function(len)
	if pa(settingsWindow) and settingsWindow.window != nil then
		...
		CreateHRLine(GAMEMODE_SETTINGS:GetContent())
		CreateCheckBoxLine(GAMEMODE_SETTINGS:GetContent(), GEN.bool_ooc, "LID_ooc", "update_bool_ooc")
		CreateCheckBoxLine(GAMEMODE_SETTINGS:GetContent(), GEN.bool_looc, "LID_looc", "update_bool_looc")
