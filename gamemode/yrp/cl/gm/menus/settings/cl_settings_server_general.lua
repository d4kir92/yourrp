...
net.Receive("Connect_Settings_General", function(len)
	...
	if pa(PARENT) then
		...
		CreateHRLine(GAMEMODE_SETTINGS:GetContent())
		CreateCheckBoxLine(GAMEMODE_SETTINGS:GetContent(), GEN.bool_chat_ooc, "LID_ooc", "update_bool_chat_ooc")
		CreateCheckBoxLine(GAMEMODE_SETTINGS:GetContent(), GEN.bool_chat_looc, "LID_looc", "update_bool_chat_looc")
		CreateCheckBoxLine(GAMEMODE_SETTINGS:GetContent(), GEN.bool_chat_role, "LID_role", "update_bool_chat_role")
		CreateCheckBoxLine(GAMEMODE_SETTINGS:GetContent(), GEN.bool_chat_group, "LID_group", "update_bool_chat_group")
		CreateCheckBoxLine(GAMEMODE_SETTINGS:GetContent(), GEN.bool_chat_yell, "LID_yell", "update_bool_chat_yell")
		CreateCheckBoxLine(GAMEMODE_SETTINGS:GetContent(), GEN.bool_chat_service, "LID_service", "update_bool_chat_service")
		...
		CreateCheckBoxLine(GAMEMODE_SETTINGS:GetContent(), GEN.bool_removebuildingownercharswitch, "LID_removethebuildingowneratcharswitch", "update_bool_removebuildingownercharswitch")
		...
		CreateCheckBoxLineTab(GAMEMODE_VISUALS:GetContent(), GEN.bool_yrp_chat_show_name, "LID_showname", "update_bool_yrp_chat_show_name")
