...
net.Receive( "Connect_Settings_General", function( len )
  if pa( settingsWindow ) then
    if pa( settingsWindow.window ) then
      ...
      local text_social_discord_widgetid = CreateTextBoxLine( SOCIAL_SETTINGS.plus, GEN.text_social_discord_widgetid, lang_string( "discord" ) .. " " .. lang_string( "serverid" ), "update_text_social_discord_widgetid" )
      local text_social_teamspeak_ip = CreateTextBoxLine( SOCIAL_SETTINGS.plus, GEN.text_social_teamspeak_ip, lang_string( "teamspeak" ) .. " [" .. lang_string( "ip" ) .."/" .. lang_string( "hostname" ) .. "]", "update_text_social_teamspeak_ip" )
      local text_social_teamspeak_port = CreateNumberWangLine( SOCIAL_SETTINGS.plus, GEN.text_social_teamspeak_port, lang_string( "teamspeak" ) .. " [" .. lang_string( "port" ) .. "]", "update_text_social_teamspeak_port" )
      local text_social_teamspeak_query_port = CreateNumberWangLine( SOCIAL_SETTINGS.plus, GEN.text_social_teamspeak_query_port, lang_string( "teamspeak" ) .. " [" .. lang_string( "queryport" ) .. "]", "update_text_social_teamspeak_query_port" )
      CreateHRLine( SOCIAL_SETTINGS.plus )
      ...
      local text_social_twitch = CreateTextBoxLine( SOCIAL_SETTINGS.plus, GEN.text_social_twitch, "Twitch", "update_text_social_twitch" )
