...
net.Receive("get_interface_settings", function(len)
	...
	if pa(settingsWindow.window) then
		...
		function settingsWindow.window.site:Paint(w, h)
			...
			surfaceText(YRP.lang_string("LID_settings_surface"), "SettingsHeader", ctr(20), ctr(10), Color(255, 255, 255), 0, 0)

			--[[ Right ]]--
			surfaceText(YRP.lang_string("LID_preview"), "SettingsHeader", ScrW2() + ctr(20), ctr(10), Color(255, 255, 255), 0, 0)
		end
		...
		function _p_color:Paint(pw, ph)
			...
			surfaceText(YRP.lang_string("LID_color"), "SettingsNormal", ctr(10), ph/2, Color(255, 255, 255), 0, 1)
		end
		...
		function _p_style:Paint(pw, ph)
			surfaceBox(0, 0, pw, ph, Color(100, 100, 255, 255))
			surfaceText(YRP.lang_string("LID_style"), "SettingsNormal", ctr(10), ph/2, Color(255, 255, 255), 0, 1)
		end
		...
		function _p_rounded:Paint(pw, ph)
			surfaceBox(0, 0, pw, ph, Color(100, 100, 255, 255))
			surfaceText(YRP.lang_string("LID_rounded"), "SettingsNormal", ctr(10), ph/2, Color(255, 255, 255), 0, 1)
		end
		...
		function _p_transparent:Paint(pw, ph)
			surfaceBox(0, 0, pw, ph, Color(100, 100, 255, 255))
			surfaceText(YRP.lang_string("LID_transparent"), "SettingsNormal", ctr(10), ph/2, Color(255, 255, 255), 0, 1)
		end
		...
		function _p_border:Paint(pw, ph)
			surfaceBox(0, 0, pw, ph, Color(100, 100, 255, 255))
			surfaceText(YRP.lang_string("LID_border"), "SettingsNormal", ctr(10), ph/2, Color(255, 255, 255), 0, 1)
		end
		...
		function _p_design:Paint(pw, ph)
			surfaceBox(0, 0, pw, ph, Color(100, 100, 255, 255))
			surfaceText(YRP.lang_string("LID_design"), "SettingsNormal", ctr(10), ph/2, Color(255, 255, 255), 0, 1)
		end
