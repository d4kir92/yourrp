...
hook.Add("open_client_keybinds", "open_client_keybinds", function()
	...
	function settingsWindow.window.site:Paint(pw, ph)
		...
		draw.SimpleTextOutlined(YRP.lang_string("LID_guimouse"), "sef", ctr(_wide), ctr(300), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		...
		draw.SimpleTextOutlined(YRP.lang_string("LID_voicenext"), "sef", ctr(_wide), ctr(600), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_voiceprev"), "sef", ctr(_wide), ctr(660), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_viewzoomout"), "sef", ctr(_wide), ctr(720), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_viewzoomin"), "sef", ctr(_wide), ctr(780), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		...
		draw.SimpleTextOutlined(YRP.lang_string("LID_viewswitch"), "sef", ctr(_wide), ctr(1080), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_incviewheight"), "sef", ctr(_wide), ctr(1140), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_decviewheight"), "sef", ctr(_wide), ctr(1200), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_viewposright"), "sef", ctr(_wide), ctr(1260), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_viewposleft"), "sef", ctr(_wide), ctr(1320), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_turnviewangleright"), "sef", ctr(_wide), ctr(1380), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_turnviewangleleft"), "sef", ctr(_wide), ctr(1440), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))

		draw.SimpleTextOutlined(YRP.lang_string("LID_opensmartphone"), "sef", ctr(_wide), ctr(1500), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_closesmartphone"), "sef", ctr(_wide), ctr(1560), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
	end
