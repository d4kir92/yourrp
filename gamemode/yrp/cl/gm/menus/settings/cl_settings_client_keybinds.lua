...
hook.Add("open_client_keybinds", "open_client_keybinds", function()
	...
	function settingsWindow.window.site:Paint(pw, ph)
		...
		draw.SimpleTextOutlined(YRP.lang_string("LID_holdtozoominview"), "sef", ctr(_wide), ctr(780), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		...
		draw.SimpleTextOutlined(YRP.lang_string("LID_laws"), "sef", ctr(_wide), ctr(1080), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))

		draw.SimpleTextOutlined(YRP.lang_string("LID_switchview"), "sef", ctr(_wide), ctr(1140), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_increaseviewingheight"), "sef", ctr(_wide), ctr(1200), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_decreaseviewingheight"), "sef", ctr(_wide), ctr(1260), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_viewingpositiontotheright"), "sef", ctr(_wide), ctr(1320), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_viewingpositiontotheleft"), "sef", ctr(_wide), ctr(1380), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_turnviewingangletotheright"), "sef", ctr(_wide), ctr(1440), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_turnviewingangletotheleft"), "sef", ctr(_wide), ctr(1500), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))

		draw.SimpleTextOutlined(YRP.lang_string("LID_presstoopensmartphone"), "sef", ctr(_wide), ctr(1560), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
		draw.SimpleTextOutlined(YRP.lang_string("LID_presstoclosesmartphone"), "sef", ctr(_wide), ctr(1640), Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color(0, 0, 0))
	end
	...
	_k._me = createDKeybinder(settingsWindow.window.site, ctr(400), ctr(50), ctr(_wide + 10), ctr(1080), "menu_laws")

	_k._vs = createDKeybinder(settingsWindow.window.site, ctr(400), ctr(50), ctr(_wide + 10), ctr(1140), "view_switch")
	_k._vu = createDKeybinder(settingsWindow.window.site, ctr(400), ctr(50), ctr(_wide + 10), ctr(1200), "view_up")
	_k._vd = createDKeybinder(settingsWindow.window.site, ctr(400), ctr(50), ctr(_wide + 10), ctr(1260), "view_down")
	_k._vr = createDKeybinder(settingsWindow.window.site, ctr(400), ctr(50), ctr(_wide + 10), ctr(1320), "view_right")
	_k._vl = createDKeybinder(settingsWindow.window.site, ctr(400), ctr(50), ctr(_wide + 10), ctr(1380), "view_left")
	_k._vsr = createDKeybinder(settingsWindow.window.site, ctr(400), ctr(50), ctr(_wide + 10), ctr(1440), "view_spin_right")
	_k._vsl = createDKeybinder(settingsWindow.window.site, ctr(400), ctr(50), ctr(_wide + 10), ctr(1500), "view_spin_left")

	_k._osp = createDKeybinder(settingsWindow.window.site, ctr(400), ctr(50), ctr(_wide + 10), ctr(1560), "sp_open")
	_k._csp = createDKeybinder(settingsWindow.window.site, ctr(400), ctr(50), ctr(_wide + 10), ctr(1640), "sp_close")
