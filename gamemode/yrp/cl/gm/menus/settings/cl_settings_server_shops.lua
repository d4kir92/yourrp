...
net.Receive("get_shops", function()
	...
	if settingsWindow.window != nil then
		...
		function _sh.eaf(tbl)
			...
			_sh._sho._name:SetHeader(YRP.lang_string("ID_name"))
		...
		function _sh.eaf2(tbl)
			...
			if pa(_sh.ea) then
				if pa(_sh._cat) then
					...
					_sh._cat._name:SetHeader(YRP.lang_string("ID_name"))
	...
	if pa(settingsWindow.window) then
		...
		function _sh.eaf3(tbl)
			...
			if pa(_sh.ea) and pa(_sh._sit) then
				...
				_sh._sit.itemname:SetHeader(YRP.lang_string("ID_name"))
				...
				_sh._sit.itemdesc:SetHeader(YRP.lang_string("ID_description"))
				...
				_sh._sit.itemprice:SetHeader(YRP.lang_string("ID_price"))
				...
				_sh._sit.itemquan:SetHeader(YRP.lang_string("ID_quantity") .. " (" .. YRP.lang_string("ID_wip") .. ")")
				_sh._sit.itemquan:INITPanel("DComboBox")
				_sh._sit.itemquan.plus.tbl = tbl
				_sh._sit.itemquan.plus:AddChoice(YRP.lang_string("ID_disabled"), -1)
				for i=1, 32 do
					_sh._sit.itemquan.plus:AddChoice(i, i)
				end
				if tonumber(tbl.quantity) == -1 then
					_sh._sit.itemquan.plus:ChooseOption(YRP.lang_string("ID_disabled"), tonumber(tbl.quantity))
				else
				...
				_sh._sit.itemcool:SetHeader(YRP.lang_string("ID_cooldown") .. " (" .. YRP.lang_string("ID_wip") .. ")")
				...
				_sh._sit.itemlice:SetHeader(YRP.lang_string("ID_licenses"))
				...
				net.Receive("get_all_licenses_simple", function(len)
					...
					if pa(_sh._sit) then
						_sh._sit.itemlice.plus:AddChoice(YRP.lang_string("ID_none"), -1)
				...
				_sh._sit.itemperm:SetHeader(YRP.lang_string("ID_permanent") .. " (" .. YRP.lang_string("ID_wip") .. ")")
				...
				_sh._sit.type:SetHeader(YRP.lang_string("ID_type"))
				_sh._sit.type:INITPanel("DComboBox")
				_sh._sit.type.plus:AddChoice(YRP.lang_string("ID_weapons"), "weapons")
				_sh._sit.type.plus:AddChoice(YRP.lang_string("ID_entities"), "entities")
				_sh._sit.type.plus:AddChoice(YRP.lang_string("ID_vehicles"), "vehicles")
				_sh._sit.type.plus:AddChoice(YRP.lang_string("ID_licenses"), "licenses")
