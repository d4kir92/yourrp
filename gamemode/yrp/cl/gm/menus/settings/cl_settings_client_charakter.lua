...
hook.Add( "open_client_character", "open_client_character", function()
	...
	function settingsWindow.window.site:Paint( w, h )
		draw.SimpleTextOutlined( YRP.lang_string( "name" ) .. ":", "sef", ctr( 10 ), ctr( 50 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_BOTTOM, 1, Color( 0, 0, 0 ) )

		draw.SimpleTextOutlined( YRP.lang_string( "description" ) .. ":", "sef", ctr( 10 ), ctr( 45 + 150 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_BOTTOM, 1, Color( 0, 0, 0 ) )
	end
