...
function CreateKeybindsContent(parent)
	...
	table.insert(keybinds, {YRP.lang_string("LID_nextvoicechannel"), "speak_next"})
	table.insert(keybinds, {YRP.lang_string("LID_previousvoicechannel"), "speak_prev"})
	...
	table.insert(keybinds, {YRP.lang_string("LID_mutevoice"), "mute_voice"})
