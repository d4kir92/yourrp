...
net.Receive("getsitehelp", function(len)
	if pa(HELPMENU.mainmenu.site) then
		...
		AddKeybindBr(keybinds)
		AddKeybind(keybinds, GetKeybindName("voice_mute"), "LID_mutevoice", "")
		AddKeybind(keybinds, GetKeybindName("voice_range_up"), "LID_voicerangeup", "")
		AddKeybind(keybinds, GetKeybindName("voice_range_dn"), "LID_voicerangedn", "")
