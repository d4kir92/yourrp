...
net.Receive( "getsitehelp", function( len )
  if pa( HELPMENU.mainmenu.site ) then
    ...
    AddKeybind( keybinds, GetKeybindName( "toggle_mouse" ),               "guimouse",           "mouse" )
    ...
    AddKeybindBr( keybinds )
    AddKeybind( keybinds, GetKeybindName( "view_switch" ),                "viewswitch",         "3d_rotation" )
    AddKeybind( keybinds, GetKeybindName( "view_up" ),                    "incviewheight",      "keyboard_arrow_up" )
    AddKeybind( keybinds, GetKeybindName( "view_down" ),                  "decviewheight",      "keyboard_arrow_down" )
    AddKeybind( keybinds, GetKeybindName( "view_right" ),                 "viewposright",       "keyboard_arrow_right" )
    AddKeybind( keybinds, GetKeybindName( "view_left" ),                  "viewposleft",        "keyboard_arrow_left" )
    AddKeybind( keybinds, GetKeybindName( "view_spin_right" ),            "turnviewangleright", "rotate_right" )
    AddKeybind( keybinds, GetKeybindName( "view_spin_left" ),             "turnviewangleleft",  "rotate_left" )
    AddKeybind( keybinds, GetKeybindName( "view_zoom_out" ),              lang_string( "viewzoomoutpre" ) .. " " .. "[" .. string.upper( nicekey( GetKeybindName( "view_zoom_out" ) ) ) .. "]" .. " " .. lang_string( "viewzoomoutpos" ),     "unfold_more" )
    AddKeybind( keybinds, GetKeybindName( "view_zoom_in" ),               lang_string( "viewzoominpre" ) .. " " .. "[" .. string.upper( nicekey( GetKeybindName( "view_zoom_in" ) ) ) .. "]" .. " " .. lang_string( "viewzoominpos" ),        "unfold_less" )
    AddKeybindBr( keybinds )
    AddKeybind( keybinds, GetKeybindName( "sp_open" ),                    lang_string( "howtoopensmartphonepre" ) .. " [" .. string.upper( nicekey( GetKeybindName( "sp_open" ) ) ) .. "] " .. lang_string( "howtoopensmartphonepos" ),       "smartphone" )
    AddKeybind( keybinds, GetKeybindName( "sp_close" ),                   lang_string( "howtoclosesmartphonepre" ) .. " [" .. string.upper( nicekey( GetKeybindName( "sp_close" ) ) ) .. "] " .. lang_string( "howtoclosesmartphonepos" ),    "system_update" )
    AddKeybindBr( keybinds )
    AddKeybind( keybinds, GetKeybindName( "speak_next" ),                 "voicenext",          "record_voice_over" )
    AddKeybind( keybinds, GetKeybindName( "speak_prev" ),                 "voiceprev",          "record_voice_over" )
  ...
  if pa( HELPMENU.mainmenu.site ) then
    ...
    for i, pl in pairs( staff ) do
      ...
      function tmp.steam:Paint( pw, ph )
        ...
        DrawIcon( GetDesignIcon( "steam" ), pw - ctr( 4 ), ph - ctr( 4 ), ctr( 2 ), ctr( 2 ), LocalPlayer():YRPGetColor( "6" ) )
      end
  ...
  if pa( HELPMENU.mainmenu.site ) then
    ...
    if collectionid > 0 then
      ...
      function openLink:Paint( pw, ph )
        surfaceButton( self, pw, ph, "" )
        DrawIcon( GetDesignIcon( "launch" ), ph, ph, 0, 0, LocalPlayer():YRPGetColor( "6" ) )
      end
...
function openHelpMenu()
  ...
  function HELPMENU.close:Paint( pw, ph )
    ...
    DrawIcon( GetDesignIcon( "close" ), ph, ph, 0, 0, LocalPlayer():YRPGetColor( "6" ) )
  end
