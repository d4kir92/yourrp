...
function showOwner(eyeTrace)
	...
	elseif eyeTrace.Entity:GetNW2String("ownerRPName") != "" or eyeTrace.Entity:GetNW2String("ownerGroup") != "" then
		draw.SimpleTextOutlined(YRP.lang_string("LID_owner") .. ": " ..	eyeTrace.Entity:GetNW2String("ownerRPName", "") .. eyeTrace.Entity:GetNW2String("ownerGroup", ""), "sef", ScrW() / 2, ScrH2() + ctr(750), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
	end
end
	...
	if ea(_eyeTrace.Entity) then
		...
		elseif _eyeTrace.Entity:IsNPC() then
			if _eyeTrace.Entity:GetNW2String("dealerID", "") != "" then
				draw.SimpleTextOutlined(_eyeTrace.Entity:GetNW2String("name", ""), "sef", ScrW() / 2, ScrH2() + ctr(150), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
				local key = {}
