...
if CLIENT then
	...
	function Player:HudValue(element, art)
		...
		elseif table.HasValue(hbools, art) then
			return YRPHUD("bool_HUD_" .. element .. "_" .. art, false) --self:GetNWBool("bool_HUD_" .. element .. "_" .. art, false)
		elseif table.HasValue(hcolors, art) then
			local hcolor = YRPHUD("color_HUD_" .. element .. "_" .. art, "255, 0, 0") -- self:GetNWString("color_HUD_" .. element .. "_" .. art, "255, 0, 0")
			hcolor = string.Explode(",", hcolor)
			return Color(hcolor[1], hcolor[2], hcolor[3], hcolor[4] or 255)
		elseif table.HasValue(hints, art) then
			return YRPHUD("int_HUD_" .. element .. "_" .. art, -1) -- tonumber(self:GetNWInt("int_HUD_" .. element .. "_" .. art, -1))
		end
...
function Player:Lockdown()
	return self:GetNWBool("bool_lockdown", false)
end

function Player:LockdownText()
	return self:GetNWString("string_lockdowntext", "")
end
