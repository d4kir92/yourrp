...
function ENT:Draw()
	...
	if self.display == nil then
		...
		function self.display:Paint(pw, ph)
			local bankName = "YRP Bank [" .. ply:GetDString("text_money_pre").. ply:GetDString("moneybank") .. ply:GetDString("text_money_pos") .."]"
			...
			elseif self.ent:GetDString("status") == "withdraw" then
				...
				draw.RoundedBox(0, 0, 300, 400, 100, Color(255, 255, 255))
				draw.SimpleTextOutlined(ply:GetDString("text_money_pre").. "5" .. ply:GetDString("text_money_pos"), "ATM_Normal", 200, 300+50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))

				draw.RoundedBox(0, 0, 450, 400, 100, Color(255, 255, 255))
				draw.SimpleTextOutlined(ply:GetDString("text_money_pre").. "10" .. ply:GetDString("text_money_pos"), "ATM_Normal", 200, 450+50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))

				draw.RoundedBox(0, 0, 600, 400, 100, Color(255, 255, 255))
				draw.SimpleTextOutlined(ply:GetDString("text_money_pre").. "20" .. ply:GetDString("text_money_pos"), "ATM_Normal", 200, 600+50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
				...
				draw.SimpleTextOutlined(ply:GetDString("text_money_pre").. "50" .. ply:GetDString("text_money_pos"), "ATM_Normal", pw-200, 300+50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))

				draw.RoundedBox(0, pw-400, 450, 400, 100, Color(255, 255, 255))
				draw.SimpleTextOutlined(ply:GetDString("text_money_pre").. "100" .. ply:GetDString("text_money_pos"), "ATM_Normal", pw-200, 450+50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
			...
			elseif self.ent:GetDString("status") == "transfer" then
				...
				if self.ent:GetDString("name1") != "nil" then
					draw.RoundedBox(0, 0, 300, 400, 100, Color(255, 255, 255))
					draw.SimpleTextOutlined(self.ent:GetDString("name1", "EMPTY"), "ATM_Name", 200, 300+50-20, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
					draw.SimpleTextOutlined(self.ent:GetDString("SteamID1", "EMPTY"), "ATM_Name", 200, 300+50+20, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
				end
				if self.ent:GetDString("name2") != "nil" then
					draw.RoundedBox(0, 0, 450, 400, 100, Color(255, 255, 255))
					draw.SimpleTextOutlined(self.ent:GetDString("name2", "EMPTY"), "ATM_Name", 200, 450+50-20, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
					draw.SimpleTextOutlined(self.ent:GetDString("SteamID2", "EMPTY"), "ATM_Name", 200, 450+50+20, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
				end
				...
				if self.ent:GetDString("name3") != "nil" then
					draw.RoundedBox(0, pw-400, 300, 400, 100, Color(255, 255, 255))
					draw.SimpleTextOutlined(self.ent:GetDString("name3", "EMPTY"), "ATM_Name", pw-200, 300+50-20, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
					draw.SimpleTextOutlined(self.ent:GetDString("SteamID3", "EMPTY"), "ATM_Name", pw-200, 300+50+20, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
				end
				if self.ent:GetDString("name4") != "nil" then
					draw.RoundedBox(0, pw-400, 450, 400, 100, Color(255, 255, 255))
					draw.SimpleTextOutlined(self.ent:GetDString("name4", "EMPTY"), "ATM_Name", pw-200, 450+50-20, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
					draw.SimpleTextOutlined(self.ent:GetDString("SteamID4", "EMPTY"), "ATM_Name", pw-200, 450+50+20, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
				end
			...
			elseif self.ent:GetDString("status") == "other" then
				...
				draw.SimpleTextOutlined(ply:GetDString("text_money_pre", "...") .. self.ent:GetDString("othermoney", "...") .. ply:GetDString("text_money_pos", "..."), "ATM_Normal", 500, 250+50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
