	...
	if self.display == nil then
		...
		function self.display:Paint(pw, ph)
			...
			elseif self.ent:GetDString("status") == "withdraw" then
				...
				draw.RoundedBox(0, 0, 300, 400, 100, Color(255, 255, 255))
				draw.SimpleTextOutlined(GetGlobalDString("text_money_pre", "") .. "5" .. GetGlobalDString("text_money_pos", ""), "ATM_Normal", 200, 300 + 50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))

				draw.RoundedBox(0, 0, 450, 400, 100, Color(255, 255, 255))
				draw.SimpleTextOutlined(GetGlobalDString("text_money_pre", "") .. "10" .. GetGlobalDString("text_money_pos", ""), "ATM_Normal", 200, 450 + 50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))

				draw.RoundedBox(0, 0, 600, 400, 100, Color(255, 255, 255))
				draw.SimpleTextOutlined(GetGlobalDString("text_money_pre", "") .. "20" .. GetGlobalDString("text_money_pos", ""), "ATM_Normal", 200, 600 + 50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
				...
				draw.SimpleTextOutlined(GetGlobalDString("text_money_pre", "") .. "50" .. GetGlobalDString("text_money_pos", ""), "ATM_Normal", pw-200, 300 + 50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))

				draw.RoundedBox(0, pw-400, 450, 400, 100, Color(255, 255, 255))
				draw.SimpleTextOutlined(GetGlobalDString("text_money_pre", "") .. "100" .. GetGlobalDString("text_money_pos", ""), "ATM_Normal", pw-200, 450 + 50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
			...
			elseif self.ent:GetDString("status") == "other" then
				...
				draw.SimpleTextOutlined(GetGlobalDString("text_money_pre", "") .. self.ent:GetDString("othermoney", "...") .. GetGlobalDString("text_money_pos", ""), "ATM_Normal", 500, 250 + 50, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
