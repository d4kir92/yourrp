...
net.Receive( "Connect_Settings_General", function( len )
  if pa( settingsWindow ) then
    if pa( settingsWindow.window ) then
      ...
      local text_social_discord_widgetid = CreateTextBoxLine( SOCIAL_SETTINGS.plus, GEN.text_social_discord_widgetid, "discord", "update_text_social_discord_widgetid" )
