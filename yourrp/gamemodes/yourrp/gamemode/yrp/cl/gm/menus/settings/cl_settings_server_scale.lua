...
function BuildScaleSite()
	...
	if pa(PARENT) then
		...
		scale_hunger:SetValue(GetGlobalFloat( "float_scale_hunger", 0) )
		...
		scale_thirst:SetValue(GetGlobalFloat( "float_scale_thirst", 0) )
		...
		scale_radiation_in:SetValue(GetGlobalFloat( "float_scale_radiation_in", 0) )
