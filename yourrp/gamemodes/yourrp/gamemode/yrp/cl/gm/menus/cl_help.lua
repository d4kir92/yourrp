...
net.Receive("getsitehelp", function(len)
	if pa(HELPMENU.mainmenu.site) then
		...
		AddKeybindBr(keybinds)
		AddKeybind(keybinds, YRPGetKeybindName("voice_mute"), "LID_mutevoice", "mute")
		AddKeybind(keybinds, YRPGetKeybindName("voice_range_up"), "LID_voicerangeup", "voice")
		AddKeybind(keybinds, YRPGetKeybindName("voice_range_dn"), "LID_voicerangedn", "voice")
		AddKeybind(keybinds, YRPGetKeybindName("voice_menu"), "LID_voicechat", "voice")
		AddKeybind(keybinds, input.GetKeyName( KEY_LSHIFT ) .. " + " .. YRPGetKeybindName("voice_menu"), "LID_nextvoicechannel", "voice")
		AddKeybindBr(keybinds)
