		...
		function self.display:Paint(pw, ph)
			...
			elseif self.ent:GetYRPString( "status" ) == "transfer" then
				...
				if self.ent:GetYRPString( "name1" ) != "nil" then
					draw.RoundedBox(0, 0, 300, 400, 100, Color( 255, 255, 255) )
					draw.SimpleTextOutlined(self.ent:GetYRPString( "name1", "EMPTY" ), "Y_40_500", 200, 300 + 50-20, Color( 0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0) )
					draw.SimpleTextOutlined(self.ent:GetYRPString( "SteamID1", "EMPTY" ), "Y_40_500", 200, 300 + 50 + 20, Color( 0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0) )
				end
				if self.ent:GetYRPString( "name2" ) != "nil" then
					draw.RoundedBox(0, 0, 450, 400, 100, Color( 255, 255, 255) )
					draw.SimpleTextOutlined(self.ent:GetYRPString( "name2", "EMPTY" ), "Y_40_500", 200, 450 + 50-20, Color( 0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0) )
					draw.SimpleTextOutlined(self.ent:GetYRPString( "SteamID2", "EMPTY" ), "Y_40_500", 200, 450 + 50 + 20, Color( 0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0) )
				end
				...
				if self.ent:GetYRPString( "name3" ) != "nil" then
					draw.RoundedBox(0, pw-400, 300, 400, 100, Color( 255, 255, 255) )
					draw.SimpleTextOutlined(self.ent:GetYRPString( "name3", "EMPTY" ), "Y_40_500", pw-200, 300 + 50-20, Color( 0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0) )
					draw.SimpleTextOutlined(self.ent:GetYRPString( "SteamID3", "EMPTY" ), "Y_40_500", pw-200, 300 + 50 + 20, Color( 0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0) )
				end
				if self.ent:GetYRPString( "name4" ) != "nil" then
					draw.RoundedBox(0, pw-400, 450, 400, 100, Color( 255, 255, 255) )
					draw.SimpleTextOutlined(self.ent:GetYRPString( "name4", "EMPTY" ), "Y_40_500", pw-200, 450 + 50-20, Color( 0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0) )
					draw.SimpleTextOutlined(self.ent:GetYRPString( "SteamID4", "EMPTY" ), "Y_40_500", pw-200, 450 + 50 + 20, Color( 0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0) )
				end
