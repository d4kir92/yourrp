...
net.Receive( "yrp_roles", function( len )
  ...
  for k, v in pairs( yrp_roles_dbTable ) do
    ...
    function tmp:DoClick()
      ...
      addDBNumberWang( rolesInfo, 800, 80, 810, 990, lang.rolesalarytime .. " (" .. lang.timeinsec .. ")", v.capitaltime, yrp_roles_dbTable[k], "yrp_roles", "capitaltime", "uniqueID = " .. tmp.uniqueID .. "" )
      addDBTextEntryBig( rolesInfo, 800, 250, 810, 1080, lang.roledescription, v.description, yrp_roles_dbTable[k], "yrp_roles", "description", "uniqueID = " .. tmp.uniqueID .. "" )
      addDBCheckBox( rolesInfo, 800, 40, 810, 1340, lang.voteable, v.voteable, yrp_roles_dbTable[k], "yrp_roles", "voteable", "uniqueID = " .. tmp.uniqueID .. "" )
      addDBCheckBox( rolesInfo, 800, 40, 810, 1390, lang.roleinstructor, v.instructor, yrp_roles_dbTable[k], "yrp_roles", "instructor", "uniqueID = " .. tmp.uniqueID .. "" )
      addDBCheckBox( rolesInfo, 800, 40, 810, 1440, lang.roleadminonly, v.adminonly, yrp_roles_dbTable[k], "yrp_roles", "adminonly", "uniqueID = " .. tmp.uniqueID .. "" )
      addDBCheckBox( rolesInfo, 800, 40, 810, 1490, lang.rolewhitelist, v.whitelist, yrp_roles_dbTable[k], "yrp_roles", "whitelist", "uniqueID = " .. tmp.uniqueID .. "" )
