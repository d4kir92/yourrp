...
function tabServerQuestions( sheet )
  ...
  function sv_questionPanel:Paint()
    ...
    draw.SimpleTextOutlined( "Questions (NOT AVAILABLE AT THE MOMENT: Is in work)", "sef", ctrW( 5 + 30 + 10 ), ctrW( 10 + 15 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0 ) )
    draw.SimpleTextOutlined( "Question", "sef", ctrW( 5 + 30 + 10 + 400 ), ctrW( 10 + 15 + 50 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0 ) )
    draw.SimpleTextOutlined( "Right Answer", "sef", ctrW( 5 + 30 + 10 + 800 + 10 + 150 ), ctrW( 10 + 15 + 50 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0 ) )
    draw.SimpleTextOutlined( "Wrong Answer", "sef", ctrW( 5 + 30 + 10 + 800 + 300 + 10 + 150 + 10 ), ctrW( 10 + 15 + 50 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0 ) )
  end
