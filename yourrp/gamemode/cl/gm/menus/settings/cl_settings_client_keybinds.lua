...
hook.Add( "open_client_keybinds", "open_client_keybinds", function()
  ...
  function settingsWindow.window.site:Paint( w, h )
    ...
    draw.SimpleTextOutlined( lang_string("viewswitch"), "sef", ctr( _wide ), ctr( 960 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
    draw.SimpleTextOutlined( lang_string("incviewheight"), "sef", ctr( _wide ), ctr( 1020 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
    draw.SimpleTextOutlined( lang_string("decviewheight"), "sef", ctr( _wide ), ctr( 1080 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
    draw.SimpleTextOutlined( lang_string("viewposright"), "sef", ctr( _wide ), ctr( 1140 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
    draw.SimpleTextOutlined( lang_string("viewposleft"), "sef", ctr( _wide ), ctr( 1200 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
    draw.SimpleTextOutlined( lang_string("turnviewangleright"), "sef", ctr( _wide ), ctr( 1260 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
    draw.SimpleTextOutlined( lang_string("turnviewangleleft"), "sef", ctr( _wide ), ctr( 1320 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
  end
  ...
  _k._vs = createDKeybinder( settingsWindow.window.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 960 ), "view_switch" )
  _k._vu = createDKeybinder( settingsWindow.window.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 1020 ), "view_up" )
  _k._vd = createDKeybinder( settingsWindow.window.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 1080 ), "view_down" )
  _k._vr = createDKeybinder( settingsWindow.window.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 1140 ), "view_right" )
  _k._vl = createDKeybinder( settingsWindow.window.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 1200 ), "view_left" )
  _k._vsr = createDKeybinder( settingsWindow.window.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 1260 ), "view_spin_right" )
  _k._vsl = createDKeybinder( settingsWindow.window.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 1320 ), "view_spin_left" )
end)
