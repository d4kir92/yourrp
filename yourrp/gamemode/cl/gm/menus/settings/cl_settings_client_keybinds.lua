...
hook.Add( "open_client_keybinds", "open_client_keybinds", function()
  ...
  _k._tm = createDKeybinder( settingsWindow.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 360 ), "toggle_map" )
  _k._mi = createDKeybinder( settingsWindow.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 420 ), "menu_inventory" )
  _k._mv = createDKeybinder( settingsWindow.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 480 ), "menu_options_vehicle" )
  _k._md = createDKeybinder( settingsWindow.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 540 ), "menu_options_door" )
  _k._sgr = createDKeybinder( settingsWindow.site, ctr( 400 ), ctr( 50 ), ctr( _wide+10 ), ctr( 600 ), "speak_next" )
