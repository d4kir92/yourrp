...
function showOwner( eyeTrace )
  if eyeTrace.Entity:GetNWString( "ownerRPName" ) != "" or eyeTrace.Entity:GetNWString( "ownerGroup" ) != "" then
    draw.SimpleTextOutlined( lang_string( "owner" ) .. ": " ..  eyeTrace.Entity:GetNWString( "ownerRPName" ) .. eyeTrace.Entity:GetNWString( "ownerGroup" ), "sef", ScrW()/2, ScrH2() + ctr( 500 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0 ) )
  end
end
...
function HudView()
  ...
  if _eyeTrace.Entity != nil and _eyeTrace.Entity != NULL then
    if ply:GetNWBool( "toggle_building", false ) and _eyeTrace.Entity:GetClass() == "prop_door_rotating" or _eyeTrace.Entity:GetClass() == "func_door" or _eyeTrace.Entity:GetClass() == "func_door_rotating" and ply:GetPos():Distance( _eyeTrace.Entity:GetPos() ) < 150 then
      ...
      draw.SimpleTextOutlined( lang_string( "holdepre" ) .. " [" .. _menu_options_door .. "] " .. lang_string( "holdepos" ), "sef", ScrW()/2, ScrH2() + ctr( 450 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0 ) )
      showOwner( _eyeTrace )
    elseif _eyeTrace.Entity:IsVehicle() and !ply:InVehicle() then
      ...
      if _eyeTrace.Entity:GetNWString( "ownerRPName" ) == ply:Nick() then
        ...
        draw.SimpleTextOutlined( lang_string( "holdevehpre" ) .. " [" .. _menu_options_vehicle .. "] " .. lang_string( "holdevehpos" ), "sef", ScrW()/2, ScrH2() + ctr( 450 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0 ) )
      end
      showOwner( _eyeTrace )
