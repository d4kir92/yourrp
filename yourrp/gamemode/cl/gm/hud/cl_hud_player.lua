...
function showIcon( string, material )
  ...
  surface.DrawTexturedRect( anchorW( cl_db[string .. "aw"] ) + ctr( cl_db[string .. "px"] ) + ctr( 30 ) - ctr( 16 ), anchorH( cl_db[string .. "ah"] ) + ctr( cl_db[string .. "py"] ) + ctr( cl_db[string .. "sh"]/2 ) - ctr( 16 ), ctr( 32 ), ctr( 32 ) )
end
      ...
      if !contextMenuOpen then
        ...
        if tonumber( cl_db["mmto"] ) == 1 then
          ...
          if minimap != nil then
            if playerfullready == true and minimap.facX != nil and minimap.facY != nil then
              ...
              elseif minimap_RT_mat != nil and _rendered then
                ...
                drawRBoxBr( 0, ctrF( ScrH() ) * anchorW( HudV( "mm" .. "aw" ) ) + HudV( "mm" .. "px" ), ctrF( ScrH() ) * anchorH( HudV( "mm" .. "ah" ) ) + HudV( "mm" .. "py" ), HudV( "mm" .. "sw" ), HudV( "mm" .. "sh" ), Color( cl_db["colbrr"], cl_db["colbrg"], cl_db["colbrb"], cl_db["colbra"] ), ctr( 4 ) )
              end
            else
              getCoordsMM()
            end
          ...
          if HudV( "mm" .. "it" ) == 1 then
            draw.SimpleTextOutlined( math.Round( ply:GetPos().x, -1 ) .. ",", "HudBars", anchorW( HudV( "mmaw" ) ) + ctr( cl_db["mmpx"] ) + ( ctr( cl_db["mmsw"] ) / 2 ), anchorH( HudV( "mmah" ) ) + ctr( cl_db["mmpy"] ) + ctr( cl_db["mmsh"] - 20 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0 ) )
            draw.SimpleTextOutlined( " " .. math.Round( ply:GetPos().y, -1 ), "HudBars", anchorW( HudV( "mmaw" ) ) + ctr( cl_db["mmpx"] ) + ( ctr( cl_db["mmsw"] ) / 2 ), anchorH( HudV( "mmah" ) ) + ctr( cl_db["mmpy"] ) + ctr( cl_db["mmsh"] - 20 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0 ) )
          end
        end
        ...
        if tonumber( cl_db["ttto"] ) == 1 then
          ...
          draw.SimpleTextOutlined( lang_string( "tooltip" ) .. ":", "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
          draw.SimpleTextOutlined( "[F2] " .. lang_string( "characterselection" ), "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 + 1*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
          draw.SimpleTextOutlined( "[F3] " .. lang_string( "rolemenu" ), "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 ) + ctr( 2*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
          draw.SimpleTextOutlined( "[F4] " .. lang_string( "buymenu" ), "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 ) + ctr( 3*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
          draw.SimpleTextOutlined( "[F7] " .. lang_string( "settings" ), "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 ) + ctr( 4*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
          draw.SimpleTextOutlined( "[F11] " .. lang_string( "guimouse" ), "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 ) + ctr( 5*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
          draw.SimpleTextOutlined( "[B] " .. lang_string( "changeview" ), "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 ) + ctr( 6*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
          draw.SimpleTextOutlined( "[M] " .. lang_string( "map" ), "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 ) + ctr( 7*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
          draw.SimpleTextOutlined( "[O] " .. "Eat Food (later consumable)", "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 ) + ctr( 8*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
          draw.SimpleTextOutlined( "[P] " .. "Drink Water (later consumable)", "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 ) + ctr( 9*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
        end
        ...
        if tonumber( cl_db["vtto"] ) == 1 and ply:GetNWBool( "voting", false ) then
          ...
          if ply:GetNWString( "voteStatus" ) != "yes" and ply:GetNWString( "voteStatus" ) != "no" then
            drawText( lang_string( "yes" ) .. " - [Picture Up] | " .. lang_string( "no" ) .. " - [Picture Down]", "vof", cl_db["vtpx"] + cl_db["vtsw"]/2, cl_db["vtpy"] + 2*(cl_db["vtsh"]/4), Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
          elseif ply:GetNWString( "voteStatus" ) == "yes" then
            drawText( lang_string( "yes" ), "vof", cl_db["vtpx"] + cl_db["vtsw"]/2, cl_db["vtpy"] + 2*(cl_db["vtsh"]/4), Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
          elseif ply:GetNWString( "voteStatus" ) == "no" then
            drawText( lang_string( "no" ), "vof", cl_db["vtpx"] + cl_db["vtsw"]/2, cl_db["vtpy"] + 2*(cl_db["vtsh"]/4), Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
          end
        ...
        if show3PInfo == 1 then
          ...
          draw.SimpleTextOutlined( _3PText, "HudBars", ScrW()/2, ctr( 2160/2 + 500 ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0 ) )
        end
      end
    else
