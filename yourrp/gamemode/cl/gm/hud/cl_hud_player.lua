...
function HudPlayer()
  ...
  if worked( cl_db, "FAILED TO LOAD HUD DATABASE" ) then
      ...
      if ply:Alive() then
        if !contextMenuOpen then
          ...
          if tonumber( cl_db["ttto"] ) == 1 then
            ...
            draw.SimpleTextOutlined( "[F8] " .. lang_string( "settings" ), "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 ) + ctr( 4*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
            ...
            draw.SimpleTextOutlined( "[I] " .. lang_string( "inventory" ), "ttsf", ctr( cl_db["ttpx"] ) + ctr( 32 ), ctr( cl_db["ttpy"] ) + ctr( 10 ) + ctr( 8*_abstand ), Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, Color( 0, 0, 0 ) )
          end
