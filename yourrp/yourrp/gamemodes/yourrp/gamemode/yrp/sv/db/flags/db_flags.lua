...
hook.Add("YRP_SQLDBREADY_GAMEPLAY_DB", "yrp_flags", function()
	...
	if YRP_SQL_SELECT(DATABASE_NAME, "*", "uniqueID = 1") == nil then YRP_SQL_INSERT_INTO(DATABASE_NAME, "string_name, string_type", "'iscp', 'role'") end
