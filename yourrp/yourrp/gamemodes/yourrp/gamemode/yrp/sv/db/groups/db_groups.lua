...
hook.Add("YRP_SQLDBREADY_GENERAL_DB", "yrp_ply_groups", function()
	...
	-- PUBLIC GROUP
	if YRP_SQL_SELECT(DATABASE_NAME, "*", "uniqueID = -1") == nil then YRP_SQL_INSERT_INTO(DATABASE_NAME, "uniqueID, string_name, string_color, int_parentgroup, bool_removeable, bool_locked, bool_visible_rm, bool_visible_cc", "-1, 'PUBLIC', '255,255,255', -1, 0, 0, 0, 0") end
end)

hook.Add("YRP_SQLDBREADY_GENERAL_UPDATE", "yrp_ply_groups", function()
...
hook.Add("YRP_SQLDBREADY_GENERAL", "yrp_ply_groups", function()
	-- Local Table
	local yrp_groups = {}
	local _init_ply_groups = YRP_SQL_SELECT(DATABASE_NAME, "*", "uniqueID = '1'")
	if IsNotNilAndNotFalse(_init_ply_groups) then yrp_groups = _init_ply_groups[1] end
	-- Network Things
...
function AddToHandler_GroupsAndRoles(ply)
	if not table.HasValue(HANDLER_GROUPSANDROLES, ply) then table.insert(HANDLER_GROUPSANDROLES, ply) end
end

function SubscribeGroupList(ply, uid)
	if HANDLER_GROUPSANDROLES["groupslist"][uid] == nil then HANDLER_GROUPSANDROLES["groupslist"][uid] = {} end
	if not table.HasValue(HANDLER_GROUPSANDROLES["groupslist"][uid], ply) then table.insert(HANDLER_GROUPSANDROLES["groupslist"][uid], ply) end
end

function UnsubscribeGroupList(ply, uid)
	if HANDLER_GROUPSANDROLES["groupslist"][uid] == nil then HANDLER_GROUPSANDROLES["groupslist"][uid] = {} end
	if table.HasValue(HANDLER_GROUPSANDROLES["groupslist"][uid], ply) then table.RemoveByValue(HANDLER_GROUPSANDROLES["groupslist"][uid], ply) end
end

function SubscribeGroup(ply, uid)
	if HANDLER_GROUPSANDROLES["groups"][uid] == nil then HANDLER_GROUPSANDROLES["groups"][uid] = {} end
	if not table.HasValue(HANDLER_GROUPSANDROLES["groups"][uid], ply) then table.insert(HANDLER_GROUPSANDROLES["groups"][uid], ply) end
end

function UnsubscribeGroup(ply, uid)
	if HANDLER_GROUPSANDROLES["groups"][uid] == nil then HANDLER_GROUPSANDROLES["groups"][uid] = {} end
	if table.HasValue(HANDLER_GROUPSANDROLES["groups"][uid], ply) then table.RemoveByValue(HANDLER_GROUPSANDROLES["groups"][uid], ply) end
end

YRP:AddNetworkString("nws_yrp_subscribe_Settings_GroupsAndRoles")
...
YRP:AddNetworkString("nws_yrp_unsubscribe_Settings_GroupsAndRoles")
...
function SendGroupList(uid)
	...
	if not IsNotNilAndNotFalse(tbl_groups) then tbl_groups = {} end
...
YRP:AddNetworkString("nws_yrp_settings_duplicate_group")
...
YRP:AddNetworkString("nws_yrp_settings_subscribe_grouplist")
...
YRP:AddNetworkString("nws_yrp_settings_add_group")
...
YRP:AddNetworkString("nws_yrp_settings_group_position_up")
...
YRP:AddNetworkString("nws_yrp_settings_group_position_dn")
...
YRP:AddNetworkString("nws_yrp_settings_subscribe_group")
...
YRP:AddNetworkString("nws_yrp_settings_unsubscribe_group")
...
YRP:AddNetworkString("nws_yrp_settings_unsubscribe_grouplist")
...
function RemoveUnusedGroups()
	...
	if count > 0 then RemoveUnusedGroups() end
end
...
function RemoveUnusedRoles()
	...
	if count > 0 then RemoveUnusedRoles() end
end
...
YRP:AddNetworkString("nws_yrp_settings_delete_group")
net.Receive("nws_yrp_settings_delete_group", function(len, ply)
	if not ply:CanAccess("bool_groupsandroles") then return end
	local guid = tonumber(net.ReadString())
	local recursive = net.ReadBool()
	if guid then DeleteGroup(guid, recursive) end
end)

YRP:AddNetworkString("nws_yrp_rolesmenu_get_groups")
...
-- Faction Selection
YRP:AddNetworkString("nws_yrp_factionselection_getfactions")
net.Receive("nws_yrp_factionselection_getfactions", function(len, ply)
	...
	local nettab = {}
	if IsNotNilAndNotFalse(dbtab2) then nettab = dbtab2 end
	net.Start("nws_yrp_factionselection_getfactions")
	net.WriteTable(nettab)
	net.Send(ply)
end)

YRP:AddNetworkString("nws_yrp_roleselection_getgroups")
...
YRP:AddNetworkString("nws_yrp_roleselection_getcontent")
YRP:AddNetworkString("nws_yrp_roleselection_getcontent_role")
YRP:AddNetworkString("nws_yrp_roleselection_getcontent_group")
...
YRP:AddNetworkString("nws_yrp_roleselection_getrole")
...
YRP:AddNetworkString("nws_yrp_char_getrole")
...
YRP:AddNetworkString("nws_yrp_settings_get_sweps")
...
YRP:AddNetworkString("nws_yrp_settings_add_sweps")
...
YRP:AddNetworkString("nws_yrp_settings_rem_sweps")
...
YRP:AddNetworkString("nws_yrp_group_getmembers")
...
function YRPSendGroupMember(ply, uid)
	...
	if char then
		...
		if prevrank then candemote = true end
...
YRP:AddNetworkString("nws_yrp_group_getmember")
...
YRP:AddNetworkString("nws_yrp_group_delmember")
net.Receive("nws_yrp_group_delmember", function(len, ply)
	...
	if IsValid(target) then YRPSetRole("nws_yrp_group_delmember", target, 1, force) end
	YRPSendGroupMember(ply, uid)
	YRPSendGroupMembers(ply)
end)
