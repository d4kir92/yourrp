...
function showOwner(eyeTrace)
	if GetGlobalYRPBool("bool_yrp_showowner", true) then
		if eyeTrace.Entity:GetOwner() ~= nil and eyeTrace.Entity:GetOwner() ~= NULL then
			draw.SimpleText(YRP.trans("LID_owner") .. ": " .. tostring(eyeTrace.Entity:GetOwner()), "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(750), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
		else
			if eyeTrace.Entity:GetRPOwner() == LocalPlayer() then
				draw.SimpleText(YRP.trans("LID_owner") .. ": " .. YRP.trans("LID_you"), "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(750), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
			elseif eyeTrace.Entity:GetRPOwner() ~= NULL and eyeTrace.Entity:GetRPOwner():IsPlayer() then
				draw.SimpleText(YRP.trans("LID_owner") .. ": " .. eyeTrace.Entity:GetRPOwner():RPName(), "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(750), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
			elseif not strEmpty(eyeTrace.Entity:GetYRPString("ownerRPName", "")) or not strEmpty(eyeTrace.Entity:GetYRPString("ownerGroup", "")) then
				...
				draw.SimpleText(YRP.trans("LID_owner") .. ": " .. eyeTrace.Entity:GetYRPString("ownerRPName", "") .. groupname, "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(750), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
			end
		end
	end
end
...
function showSecurityLevel(door)
	if door:SecurityLevel() > 0 and GetGlobalYRPBool("bool_building_system", false) and GetGlobalYRPBool("bool_securitylevel_system", false) and GetGlobalYRPBool("bool_show_securitylevel", true) then
		draw.SimpleText(YRP.trans("LID_securitylevel") .. ": " .. door:SecurityLevel(), "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(800), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
	end
end
	...
	if _eyeTrace.Entity and YRPEntityAlive(_eyeTrace.Entity) then
		...
		if YRPEntityAlive(ent) then
			...
			if GetGlobalYRPBool("bool_building_system", false) and ent:YRPIsDoor() and plypos:Distance(entpos) < GetGlobalYRPInt("int_door_distance", 200) and GetGlobalYRPBool("bool_canbeowned", true) then
				...
				draw.SimpleText(YRP.trans("LID_presstoopen", tab), "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(650), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
				...
				if canbeowned or lply:HasAccess("YRPHudView") then
					...
					draw.SimpleText(YRP.trans("LID_presstoopensettings", tab2), "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(700), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
					showOwner(_eyeTrace)
			...
			elseif ent:IsVehicle() and not lply:InVehicle() then
				local tab = {}
				tab["KEY"] = "[" .. string.upper(YRPGetKeybindName("in_use")) .. "]"
				draw.SimpleText(YRP.trans("LID_presstogetin", tab), "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(650), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
			...
			elseif ent:IsPlayer() then
				if ent:GetColor().a ~= 0 or not ent:GetYRPBool("cloaked") then
					...
					--draw.SimpleText(YRP.trans( "LID_presstointeractwith", tab), "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(700), Color( 255, 255, 255, plycol.a), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0, 255 ) )
				end
			elseif ent:IsNPC() then
				if ent:IsDealer() then
					...
					draw.SimpleText(YRP.trans("LID_presstotrade", key), "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(200), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
				end
			elseif ent:GetClass() == "yrp_clothing" and plypos:Distance(entpos) < 150 then
				local key = {}
				key["KEY"] = "[" .. string.upper(YRPGetKeybindName("in_use")) .. "]"
				draw.SimpleText(YRP.trans("LID_presstochangeyourclothes", key), "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(650), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
			elseif ent:HasStorage() and plypos:Distance(entpos) < 150 then
				local key = {}
				key["KEY"] = "[" .. string.upper(YRPGetKeybindName("in_use")) .. "]"
				key["NAME"] = ent:StorageName()
				draw.SimpleText(YRP.trans("LID_presstoopenname", key), "Y_24_500", ScrW() / 2, ScrH2() + YRP.ctr(700), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255))
