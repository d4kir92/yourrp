...
net.Receive( "nws_yrp_connect_Settings_General", function( len )
	...
	if PanelAlive(PARENT) then
		...
		CreateNumberWangLine(SERVER_SETTINGS:GetContent(), GEN.text_server_collectionid, "LID_collectionid", "nws_yrp_update_text_server_collectionid" )
		CreateHRLine(SERVER_SETTINGS:GetContent() )
		...
		CreateCheckBoxLine(SERVER_SETTINGS:GetContent(), GEN.bool_msg_channel_lang, "Console Language (LANG)", "nws_yrp_update_bool_msg_channel_lang" )
		CreateCheckBoxLine(SERVER_SETTINGS:GetContent(), GEN.bool_msg_channel_noti, "Console Notification (NOTI)", "nws_yrp_update_bool_msg_channel_noti" )
		...
		CreateCheckBoxLine(SERVER_SETTINGS:GetContent(), GEN.bool_msg_channel_chat, "Console Chat (CHAT)", "nws_yrp_update_bool_msg_channel_chat" )
		...
		CreateHRLine(GAMEMODE_SETTINGS:GetContent() )
		CreateCheckBoxLine(GAMEMODE_SETTINGS:GetContent(), GEN.bool_players_can_drop_weapons, "LID_playerscandropweapons", "nws_yrp_update_bool_players_can_drop_weapons" )
		CreateHRLine(GAMEMODE_SETTINGS:GetContent() )
		...
		local wc_mdl = CreateButtonLine(GAMEMODE_SYSTEMS:GetContent(), YRP.lang_string( "LID_appearance" ) .. " ( " .. YRP.lang_string( "LID_model" ) .. " )", "nws_yrp_update_text_appearance_model", "LID_change" )
		...
		CreateCheckBoxLine(MONEY_SETTINGS:GetContent(), GEN.bool_drop_money_on_death, "LID_dropmoneyondeath", "nws_yrp_update_bool_drop_money_on_death" )
