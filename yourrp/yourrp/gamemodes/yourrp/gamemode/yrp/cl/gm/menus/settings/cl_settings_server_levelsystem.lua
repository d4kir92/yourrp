		...
		function diagramm:Paint(pw, ph)
			...
			for i, v in pairs(coords) do
				if i < max then
					...
					p1 = br + p1
					p2 = br + p2
					if i == min then draw.SimpleTextOutlined(coords[i], "DermaDefault", br - YRP:ctr(10), p1, Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0, 255)) end
