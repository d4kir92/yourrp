						...
						if IsValid( ply ) then
							if v.func and ply[v.func] then
								...
								if ply:LoadedGamemode() and YRP.GetDesignIcon( "circle" ) and v.cfun and ply[v.cfun] and ply:CharID() > 0 then
									if v.name != "usergroup" and ply:IsInCharacterSelection() then
								...
								if v.name == "language" then
									...
									if v.name == "name" then
										if !ply:LoadedGamemode() then
											text = "[" .. YRP.lang_string( "LID_loading" ) .. "]"
										elseif ply:IsInCharacterSelection() then
											text = "[" .. YRP.lang_string( "LID_characterselection" ) .. "]"
										end
									end
									if v.name == "rolename" or v.name == "groupname" or v.name == "idcardid" then
										if !ply:LoadedGamemode() or ply:IsInCharacterSelection() then
											text = ""
										end
									end
									if v.name == "usergroup" then
