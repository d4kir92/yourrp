						...
						function rt:ActionSignal(signalName, signalValue)
							if signalName == "TextClicked" then
								if (signalValue == v.string_source_steamid) and source:IsPlayer() then
									source:ShowProfile()
								elseif signalValue == v.string_target_steamid then
									if IsValid(target) then target:ShowProfile() end
								end
							end
						end
...
function BuildLogsSite()
	...
	if YRPPanelAlive(PARENT) then
		...
		tabs:AddOption("LID_kills", function(parent) BuildLogs(parent, "LID_kills") end)
		tabs:AddOption("LID_health", function(parent) BuildLogs(parent, "LID_health") end)
		tabs:AddOption("LID_chat", function(parent) BuildLogs(parent, "LID_chat") end)
		tabs:AddOption("LID_arrests", function(parent) BuildLogs(parent, "LID_arrests") end)
		tabs:AddOption("LID_connections", function(parent) BuildLogs(parent, "LID_connections") end)
		tabs:AddOption("LID_whitelist", function(parent) BuildLogs(parent, "LID_whitelist") end)
		tabs:AddOption("LID_spawns", function(parent) BuildLogs(parent, "LID_spawns") end)
