...
AddCSLuaFile( "yrp/cl/gm/huds/cl_hud_space.lua" )
...
AddCSLuaFile( "yrp/cl/gm/menus/cl_groupmenu.lua" )
AddCSLuaFile( "yrp/cl/gm/menus/cl_char.lua" )
AddCSLuaFile( "yrp/cl/gm/menus/cl_keybinds.lua" )
...
AddCSLuaFile( "yrp/cl/gm/menus/settings/cl_settings_server_characters.lua" )
AddCSLuaFile( "yrp/cl/gm/menus/settings/cl_settings_server_events.lua" )
...
AddCSLuaFile( "yrp/cl/gm/menus/settings/cl_settings_server_specializations.lua" )
...
AddCSLuaFile( "yrp/cl/gm/menus/settings/cl_settings_server_blacklist.lua" )
AddCSLuaFile( "yrp/cl/gm/menus/settings/cl_settings_server_logs.lua" )
AddCSLuaFile( "yrp/cl/gm/menus/settings/cl_settings_server_logs_settings.lua" )
...
AddCSLuaFile( "yrp/cl/gm/menus/settings/cl_settings_server_weapon.lua" )
